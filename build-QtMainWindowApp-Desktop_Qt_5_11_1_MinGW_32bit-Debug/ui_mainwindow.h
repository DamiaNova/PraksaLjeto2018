...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionSpanjolski = new QAction(MainWindow);
        actionSpanjolski->setObjectName(QStringLiteral("actionSpanjolski"));
        ...
        menuJezik->setGeometry(QRect(339, 114, 155, 126));
        ...
        menuJezik->addAction(actionSpanjolski);
